    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          ...
          <CustomLink href='https://club.mahechen.com/' title="Teaching" className="ml-4" />
        </nav>
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <button
            ...
            className={`w-6 h-6 ml-3 flex items-center justify-center rounded-full p-1 ${mode === "light" ? "bg-dark text-light" : "bg-light text-dark"}
     `}
          >
            {
              mode === "dark" ?
        ...
        isOpen ?
          ...
          <motion.div
            ...
            <nav className="flex items-center flex-col justify-center">
              ...
              <CustomMobileLink href='https://club.mahechen.com/' title="Teaching" className="" toggle={handleCLick} />
            </nav>
            ...
            <nav className="flex items-center justify-center flex-wrap mt-2">
              ...
              { <button
                onClick={() => setMode(mode === "light" ? "dark" : "light")}
                className={`w-8 mx-3 rounded-full sm:mx-1 ${mode === "light" ? "bg-dark text-light"
                : "bg-light text-dark"}
     `}
              >
                {
