...
const about = () => {
  return (
    <>
      <Head>
      <title>About Mahe Chen</title>
        <meta name="description" content="About Mahe Chen" />
      </Head>
      <TransitionEffect />
      <main className="flex w-full flex-col items-center justify-center dark:text-light overflow-auto">
        <Layout className="pt-16">
          <AnimatedText text="About Mahe Chen" className="mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8" />
